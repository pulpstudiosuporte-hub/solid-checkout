...
const faqs = [
  ['Posso explorar o checkout neste site?', 'Sim. Altere cores, ofertas e entrega para conhecer a jornada. Este ambiente não gera cobranças nem envia dados.'],
  ['O que é order bump?', 'É um complemento opcional oferecido dentro do checkout. O comprador pode incluir o complemento no pedido e conferir o valor antes de pagar.'],
  ['Posso configurar cupons e frete?', 'Sim. Defina as regras dos seus cupons e as opções de entrega no painel. O comprador confere o desconto e o frete no resumo do pedido.'],

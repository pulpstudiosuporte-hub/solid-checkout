...
const automaticReleases = [
  { publicId: 'auto-20260902-optional-gateway-mfa', category: 'IMPROVEMENT' as const, title: 'Integrações sem 2FA obrigatório', description: 'Conectar e administrar gateways não exige mais ativar o aplicativo autenticador. O segundo fator continua disponível como uma proteção opcional e recomendada para a conta.', publishedAt: new Date('2026-09-02T21:30:00.000Z') },
  { publicId: 'auto-20260902-testimonial-avatar', category: 'IMPROVEMENT' as const, title: 'Depoimentos com visual mais autêntico', description: 'Fotos enviadas nos elementos de depoimento e avaliações agora são otimizadas e exibidas como avatares circulares, com enquadramento consistente na personalização, no celular e no checkout publicado.', publishedAt: new Date('2026-09-02T20:00:00.000Z') },
  { publicId: 'auto-20260902-checkout-seo', category: 'IMPROVEMENT' as const, title: 'SEO e identidade do checkout', description: 'A personalização agora permite definir o título da aba, a descrição para buscadores e um favicon próprio para cada checkout. Também corrigimos a publicação de blocos de texto que usam somente título ou somente descrição.', publishedAt: new Date('2026-09-02T18:30:00.000Z') },
  { publicId: 'auto-20260902-checkout-text-element', category: 'IMPROVEMENT' as const, title: 'Novo elemento de texto no checkout', description: 'O editor ganhou um bloco de texto que pode ser usado na faixa superior, no conteúdo principal ou abaixo do resumo lateral. Título e descrição têm cores, tamanhos, peso, altura de linha, alinhamento, fundo e espaçamento próprios, com o mesmo resultado na prévia e no checkout publicado.', publishedAt: new Date('2026-09-02T16:00:00.000Z') },
  { publicId: 'auto-20260902-checkout-footer', category: 'IMPROVEMENT' as const, title: 'Rodapé avançado no checkout', description: 'O rodapé agora permite escolher cores, alinhamento, espaçamento e organização. Também é possível selecionar formas de pagamento, informar dados da empresa, exibir selo de segurança e controlar os links legais, com o mesmo resultado na personalização e no checkout publicado.', publishedAt: new Date('2026-09-02T14:30:00.000Z') },
  { publicId: 'auto-20260902-checkout-publish', category: 'FIX' as const, title: 'Publicação do checkout corrigida', description: 'Corrigimos a validação do estilo de etapas com ícones. Personalizações que usam “Ícones com contorno” agora são salvas e publicadas normalmente.', publishedAt: new Date('2026-09-02T12:00:00.000Z') },
  ...
  { publicId: 'auto-20260901-shopify-menu', category: 'FIX' as const, title: 'Tutorial Shopify com os menus corretos', description: 'O passo a passo agora separa claramente as telas do Dev Dashboard: permissões em Versões, instalação em Início e ID do cliente e chave secreta em Configurações → Credenciais.', publishedAt: new Date('2026-09-01T23:45:00.000Z') },
  { publicId: 'auto-20260901-shopify-guide', category: 'INTEGRATION' as const, title: 'Conexão Shopify com app próprio e renovação automática', description: 'O tutorial agora ensina cada lojista a criar e instalar seu próprio app no Dev Dashboard, liberar somente produtos e pedidos, conectar Client ID e Client secret com criptografia e sincronizar o catálogo. Os tokens de 24 horas são renovados automaticamente pela SOLID.', publishedAt: new Date('2026-09-01T23:30:00.000Z') },

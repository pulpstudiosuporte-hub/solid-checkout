...
const automaticReleases = [
  { publicId: 'auto-20260901-shopify-guide', category: 'INTEGRATION' as const, title: 'Tutorial completo de conexão com a Shopify', description: 'A integração Shopify agora orienta o lojista em seis etapas: localizar o domínio original, autorizar o app, sincronizar o catálogo, publicar o checkout, ativar o App Embed no tema e validar uma compra de teste.', publishedAt: new Date('2026-09-01T23:30:00.000Z') },

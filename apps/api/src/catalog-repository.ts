...
export interface CatalogRepository {
  ...
  createProduct(context: StoreContext, input: ProductInput, requestId: string): Promise<unknown>;
  listCheckouts(context: StoreContext): Promise<readonly unknown[]>;
  createCheckout(context: StoreContext, input: CheckoutInput, requestId: string): Promise<unknown | null>;
}
...
export class PrismaCatalogRepository implements CatalogRepository {
  ...
  async createProduct(context: StoreContext, input: ProductInput, requestId: string): Promise<unknown> {
  ...
  async createCheckout(context: StoreContext, input: CheckoutInput, requestId: string): Promise<unknown | null> {

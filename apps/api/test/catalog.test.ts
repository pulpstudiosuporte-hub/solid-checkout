...
class MemoryCatalog implements CatalogRepository {
  ...
  setPublicOrderBump(publicId: string, tokenHash: string, enabled: boolean): Promise<object | null> { return Promise.resolve(publicId === 'session-a' && tokenHash ? { totalCents: enabled ? 14900 : 9900, shippingPriceCents: 0, grandTotalCents: enabled ? 14900 : 9900, enabled } : null); }

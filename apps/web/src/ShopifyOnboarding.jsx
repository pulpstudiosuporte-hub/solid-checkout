...
const guide = [
  ...
  {
    key: 'theme', title: 'Ative o redirecionamento no tema', icon: ShoppingBag, description: 'Cole uma única vez a ponte segura da SOLID.', path: 'Shopify Admin → Loja virtual → Temas → … → Editar código → layout/theme.liquid', code: themeSnippet, manual: true,
    instructions: ['Abra o arquivo layout/theme.liquid do tema publicado.', 'Localize </body> perto do final do arquivo.', 'Cole o código abaixo imediatamente antes de </body> e salve.', 'Abra sua loja em uma janela anônima, adicione produtos ao carrinho e clique em Finalizar compra.', 'A SOLID recebe o carrinho assinado pela Shopify. Se a SOLID estiver indisponível, o checkout nativo será usado automaticamente.'],
  },
];

...
export const docsArticles = [
  ...
  article('analises', 'vendas', 'Análises e carrinhos', 'Leia os números da loja sem confundir intenção de compra com receita.', {
    ...
    details: [{ id: 'painel-de-bordo', title: 'Seu painel de bordo', items: ['Em Gestão → Início, os quatro indicadores do topo mostram visitantes ativos, valor dos pedidos gerados, pedidos pagos hoje e conversão. Pedidos gerados incluem intenção de compra; não representam receita confirmada.', 'O gráfico de receita aparece logo abaixo dos indicadores. Escolha o período no próprio gráfico e consulte o ticket médio e os Pix pendentes no resumo ao lado.', 'Mais abaixo, acompanhe o alcance geográfico, as Novidades e os atalhos para checkout, ofertas e carrinhos. O mapa tem seu próprio filtro de período.', 'Use o botão de aparência no topo para alternar entre claro e escuro. No celular, os cards se reorganizam e a navegação fica no botão Abrir menu.'] }],

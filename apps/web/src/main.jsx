...
import {
  ...
  Tag, TrendingUp, Truck, Users, X, Zap, LogOut, ServerCog, Webhook, Megaphone
} from 'lucide-react';
import './styles.css';
...
const navGroups = [
  { label: 'Gestão', items: [
    ...
    { label: 'Carrinhos', icon: ShoppingCart }, { label: 'Produtos', icon: Package }, { label: 'Webhooks', icon: Webhook },
  ]},

...
function App(){
  ...
  useEffect(()=>{const refresh=()=>getStores().then(result=>setStores(result.items)).catch(()=>{});window.addEventListener('solid:onboarding-updated',refresh);return()=>window.removeEventListener('solid:onboarding-updated',refresh)},[]);

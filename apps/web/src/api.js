...
export async function getDashboard(period, signal, options = {}) { const query = new URLSearchParams({ period, ...options }); return readJson(await fetch(`${apiBaseUrl}/dashboard?${query}`, { credentials: 'include', headers: { Accept: 'application/json' }, signal })); }
...
export async function getSettings() { return readJson(await fetch(`${apiBaseUrl}/settings`, { credentials: 'include', headers: { Accept: 'application/json' } })); }
export async function saveSettings(section, values, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/settings`, { method: 'PATCH', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify({ section, values }) })); }
...
export async function connectShopifyCredentials(shop, clientId, clientSecret, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/integrations/shopify/connect-credentials`, { method: 'POST', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify({ shop, clientId, clientSecret }) })); }
...
export async function uploadPlatformImage(file, csrfToken) { const form = new FormData(); form.append('image', file); return readJson(await fetch(`${apiBaseUrl}/admin/content/media`, { method: 'POST', credentials: 'include', headers: { Accept: 'application/json', 'x-csrf-token': csrfToken }, body: form })); }
...
export async function getPublicSocialProof(sessionId, token, signal) { return readJson(await fetch(`${apiBaseUrl}/public/checkout-sessions/${encodeURIComponent(sessionId)}/social-proof`, { headers: { Accept: 'application/json', Authorization: `Bearer ${token}` }, signal })); }
...
export async function sendChromaSenseEvents(sessionId, token, payload, keepalive = false) { const response = await fetch(`${apiBaseUrl}/public/checkout-sessions/${encodeURIComponent(sessionId)}/chromasense/events`, { method: 'POST', headers: { 'Content-Type': 'application/json', Accept: 'application/json', Authorization: `Bearer ${token}` }, body: JSON.stringify(payload), keepalive }); if (response.status !== 204 && response.status !== 202) return readJson(response); }
export async function getChromaSense(filters = {}, signal) { const query = new URLSearchParams(); if (filters.period) query.set('period', filters.period); if (filters.checkoutId) query.set('checkoutId', filters.checkoutId); if (filters.device) query.set('device', filters.device); return readJson(await fetch(`${apiBaseUrl}/chromasense?${query}`, { credentials: 'include', headers: { Accept: 'application/json' }, signal })); }
...
export async function getGoogleIntegration(signal, storeKey) { return readJson(await fetch(`${apiBaseUrl}/integrations/google${storeKey ? `?store=${encodeURIComponent(storeKey)}` : ""}`, { credentials: 'include', signal })); }
export async function saveGoogleIntegration(config, csrfToken, signal, storeKey) { return readJson(await fetch(`${apiBaseUrl}/integrations/google${storeKey ? `?store=${encodeURIComponent(storeKey)}` : ""}`, { method: 'PUT', credentials: 'include', headers: { 'Content-Type': 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(config), signal })); }
export async function disconnectGoogleIntegration(csrfToken, signal, storeKey) { const response = await fetch(`${apiBaseUrl}/integrations/google${storeKey ? `?store=${encodeURIComponent(storeKey)}` : ""}`, { method: 'DELETE', credentials: 'include', headers: { 'x-csrf-token': csrfToken }, signal }); if (response.status !== 204) return readJson(response); }
export async function getPublicGoogleConfig(sessionId, token, signal) { return readJson(await fetch(`${apiBaseUrl}/public/checkout-sessions/${encodeURIComponent(sessionId)}/tracking/google`, { headers: { Accept: 'application/json', Authorization: `Bearer ${token}` }, signal })); }
...
export async function setPrimaryGateway(provider, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/integrations/gateways/primary`, { method: 'PUT', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify({ provider }) })); }
export async function disconnectGateway(provider, csrfToken) { const response = await fetch(`${apiBaseUrl}/integrations/gateways/${encodeURIComponent(provider)}`, { method: 'DELETE', credentials: 'include', headers: { Accept: 'application/json', 'x-csrf-token': csrfToken } }); if (response.status !== 204) return readJson(response); }
...
export async function updateOrderStatus(orderId, input, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/orders/${encodeURIComponent(orderId)}/status`, { method: 'PATCH', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(input) })); }
export async function saveOrderTracking(orderId, input, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/orders/${encodeURIComponent(orderId)}/tracking`, { method: 'PUT', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(input) })); }
export async function setOrderVisitorBlocked(orderId, blocked, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/orders/${encodeURIComponent(orderId)}/block-visitor`, { method: 'POST', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify({ blocked }) })); }
...
export async function getAdminUsers(status = 'APPROVED', page = 1, search = '') { return readJson(await fetch(`${apiBaseUrl}/admin/users?status=${encodeURIComponent(status)}&page=${page}&search=${encodeURIComponent(search)}`, { credentials: 'include', headers: { Accept: 'application/json' } })); }
...
export async function getPlatformContent(signal) { return readJson(await fetch(`${apiBaseUrl}/platform-content`, { credentials: 'include', headers: { Accept: 'application/json' }, signal })); }
export async function getAdminContent(signal) { return readJson(await fetch(`${apiBaseUrl}/admin/content`, { credentials: 'include', headers: { Accept: 'application/json' }, signal })); }
export async function createAdminFeedback(input, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/admin/content/feedback`, { method: 'POST', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(input) })); }
export async function updateAdminFeedback(feedbackId, input, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/admin/content/feedback/${encodeURIComponent(feedbackId)}`, { method: 'PATCH', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(input) })); }
export async function deleteAdminFeedback(feedbackId, csrfToken) { const response = await fetch(`${apiBaseUrl}/admin/content/feedback/${encodeURIComponent(feedbackId)}`, { method: 'DELETE', credentials: 'include', headers: { Accept: 'application/json', 'x-csrf-token': csrfToken } }); if (!response.ok) return readJson(response); }
export async function createAdminRelease(input, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/admin/content/releases`, { method: 'POST', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(input) })); }
export async function updateAdminRelease(releaseId, input, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/admin/content/releases/${encodeURIComponent(releaseId)}`, { method: 'PATCH', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(input) })); }
export async function deleteAdminRelease(releaseId, csrfToken) { const response = await fetch(`${apiBaseUrl}/admin/content/releases/${encodeURIComponent(releaseId)}`, { method: 'DELETE', credentials: 'include', headers: { Accept: 'application/json', 'x-csrf-token': csrfToken } }); if (!response.ok) return readJson(response); }
export async function saveAdminIntegrationAsset(integrationKey, input, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/admin/content/integrations/${encodeURIComponent(integrationKey)}`, { method: 'PUT', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(input) })); }
export async function sendAdminBroadcast(input, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/admin/content/broadcasts`, { method: 'POST', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(input) })); }

export async function getPixDiscount() { return readJson(await fetch(`${apiBaseUrl}/payment-discounts/pix`, { credentials: 'include', headers: { Accept: 'application/json' } })); }
export async function savePixDiscount(input, csrfToken) { return readJson(await fetch(`${apiBaseUrl}/payment-discounts/pix`, { method: 'PUT', credentials: 'include', headers: { 'Content-Type': 'application/json', Accept: 'application/json', 'x-csrf-token': csrfToken }, body: JSON.stringify(input) })); }

export async function getPublicExitOffer(sessionId, token, signal) { return readJson(await fetch(`${apiBaseUrl}/public/checkout-sessions/${encodeURIComponent(sessionId)}/exit-offer`, { headers: { Accept: "application/json", Authorization: `Bearer ${token}` }, signal })); }

...
export function MerchantLife() {
  return <section className="pirat-people" id="lojistas" aria-labelledby="people-title"><div className="site-container"><div className="pirat-people-heading"><div><span className="site-eyebrow">POR TRÁS DE CADA LOJA, TEM ALGUÉM.</span><h2 id="people-title">Seu negócio é sério.<br/><span>Sua marca pode ter alma.</span></h2></div><p>Tem quem escolhe cada produto. Quem embala com cuidado. Quem acompanha cada pedido. A Pirat foi feita para fazer parte dessa rotina.</p></div><div className="pirat-people-grid"><figure><img src="/brand/people/merchant-packing.jpg" width="600" height="720" loading="lazy" alt="Lojista sorrindo com uma caixa pronta para envio"/><figcaption><span>PARA QUEM EMPREENDE</span><h3>Uma ideia sua.<br/>Uma experiência inteira.</h3></figcaption></figure><div className="pirat-people-right"><figure><img src="/brand/people/team-packing.jpg" width="900" height="560" loading="lazy" alt="Duas pessoas organizando e embalando pedidos de uma loja"/><figcaption><span>PARA QUEM FAZ ACONTECER</span><h3>Mais clareza para<br/>tocar a operação.</h3></figcaption></figure><div className="pirat-people-note"><Package size={28}/><p>Do cuidado com o produto<br/><b>ao cuidado com a compra.</b></p><ArrowUpRight size={26}/></div></div></div><p className="pirat-photo-credit">Fotografias: <a href="https://www.pexels.com/photo/woman-smiling-while-holding-the-package-7289733/" target="_blank" rel="noreferrer">Kampus Production</a> e <a href="https://www.pexels.com/photo/women-packing-orders-into-cardboard-boxes-7674983/" target="_blank" rel="noreferrer">Pavel Danilyuk / Pexels</a>.</p></div></section>;
}

...
export default function LandingPage() {
  ...
  return <div className="solid-site" id="inicio">
    ...
    <footer className="site-footer site-container"><div className="footer-top"><div><Brand footer/><p>Sua marca no comando.<br/>Sua próxima venda à vista.</p></div><div className="footer-links"><div><strong>Plataforma</strong><a href="#recursos">Recursos</a><a href="#como-funciona">Como funciona</a><a href="#integracoes">Integrações</a></div><div><strong>Comece aqui</strong><a href={signup}>Criar conta</a><a href={login}>Acessar painel</a><a href="#duvidas">Perguntas frequentes</a></div></div></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Pirat Checkout. Todos os direitos reservados.</span><a href="#inicio">Feito para seguir em frente. <ArrowUpRight size={14}/></a></div></footer>
  </div>;
}

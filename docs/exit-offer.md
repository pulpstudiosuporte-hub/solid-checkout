...
- Computador: depois do tempo mínimo, detecta a entrada do cursor na região superior esquerda (até 200 px de largura, limitada a 35% da janela, e 100 px de altura), vindo de baixo ou da direita. Antecipa o movimento em direção ao botão Voltar enquanto o mouse ainda está dentro da página. Também detecta os 24 px superiores e a saída pelo topo, sem exigir clique ou tecla antes. Não acessa a posição do cursor na barra do navegador.
